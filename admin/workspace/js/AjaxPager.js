...
var AjaxPager ={
	$ : function(url,params,callFunc,pageID){
		...
		obj.url=url;
		obj.params=params;//参数集合中，rowsPerPage=0时不进行分布处理
		obj.pageID=pageID;
		...
		obj.getPagerTip=function(){
			return "<div id='"+obj.pageID+".tip' style='text-align:center; height:16'><img class='load-pic' src='../images/load1.png'>上拉加载更多</div>";
		}
		obj.runAs=function(){
			...
			$.ajax({
				...
				beforeSend:function () {
				    //$("#loadPic").css("display","block")    // 显示loading
				},
