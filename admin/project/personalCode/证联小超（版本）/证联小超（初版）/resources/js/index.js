...
$(function(){
    ...
    $(".addBtn").click( function () {
        ...
        var shopId =$(this).parent(".lt-rt").parent(".rt-info").parent(".prt-rt").parent(".section-li").attr("id"); //获取商品ID
        var img =$(this).parent(".lt-rt").parent(".rt-info").parent(".prt-rt").prev(".prt-lt").find("img")[0].src; //商品logo
